...
class ArrayListIterator(object):
    ...
    def previous(self):
        ...
        The list has not been modified except by this iterators' mutators.
    ...
    def replace(self, item):
        ...
        Raises: AttributeError if position is not defined.
        AttributeError if illegal mutation of backing store."""
    ...
    def insert(self, item):
        """Preconditions:
        The list has not been modified except by this iterators' mutators.
        Adds item to the end of the current position is undefined, or
        ...
        if self._lastItemPos == -1:
            ...
            self._backingStore.inert(self._lastItemPos, item)
            self._lastItemPos = -1
        self._modCount += 1
